...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            //线索表单保存按钮提交表单到后台，成功后关闭模态窗口
            $("#saveBtn").click(function () {
                $.ajax({
                    url:"workbench/clue/save",
                    type:"post",
                    dataType:"json",
                    data:$("#create-clue-form").serialize(),
                    success:function (result) {
                        alert(result.status);
                ...
                <form class="form-horizontal" role="form" id="create-clue-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <select class="form-control" id="create-clueOwner" name="owner" value="${loginUser.id}">
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td><a style="text-decoration: none; cursor: pointer;"
                           onclick="window.location.href='workbench/clue/detail?id=9172b3306dd8469aafaab7f108047318';">李四先生</a></td>
                    <td>动力节点</td>
                    <td>010-84846003</td>
                    <td>12345678901</td>
                    <td>广告</td>
